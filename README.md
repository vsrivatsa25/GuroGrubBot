## GuroGrubBot
```python
print("Consider sponsoring me a coffee")
```
https://ko-fi.com/vsrivatsa25

![alt text](1718969-200.png "GuroGrubBot")

My Twitter Music Genius Bot

Tweets lyrics that GuroGrubBot finds interesting, at fixed intervals. Requires cloud server to run automatically.

Currently, GuroGrubBot is being run as a IBM Cloud Foundry app, on GB server.

Project open for further development. Fork and get in touch if interested

If deploying, ensure API keys are modified properly on tweet.py

## Deploy App on IBM Cloud
